...
#ifdef STM32H750xx
#define OV2640_PWDN_PIN            			 GPIO_PIN_7	        				 	// PWDN 引脚      
#define OV2640_PWDN_PORT           			 GPIOG                 			 	// PWDN GPIO端口     
#define GPIO_OV2640_PWDN_CLK_ENABLE    	__HAL_RCC_GPIOG_CLK_ENABLE() 		// PWDN GPIO端口时钟
