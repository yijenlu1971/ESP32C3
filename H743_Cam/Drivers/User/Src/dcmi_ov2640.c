...
int8_t DCMI_OV2640_Init(void)
{
	...
	OV2640_PWDN_OFF;  // PWDN 引脚输出低电平，不开启掉电模式
  HAL_Delay(140);    
	DCMI_RST_H
...
//		OV2640_Config( OV2640_UXGA_Config );                  // 配置 UXGA模式  ------>  1600*1200，最大帧率15帧
		...
		OV2640_Set_Vertical_Flip(1);      //市售OV2640 有差异， 有的需要垂直翻转
		OV2640_Set_Horizontal_Mirror(1);  //市售OV2640 有差异， 有的需要水平镜像
